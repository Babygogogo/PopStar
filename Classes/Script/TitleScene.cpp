...
std::unique_ptr<GameObject> TitleScene::impl::createTitleLayer()
{
	...
	title_layer_object->addComponent<DisplayNode>()->initAs<DisplayNode::Layer>();

	title_layer_object->addChild(createBackground());
	title_layer_object->addChild(createStartButton());
...
std::unique_ptr<GameObject> TitleScene::impl::createBackground()
{
	...
	auto background_sprite = background_object->addComponent<DisplayNode>()->initAs<DisplayNode::Sprite>("bg_menuscene.jpg");
...
std::unique_ptr<GameObject> TitleScene::impl::createStartButton()
{
	...
	auto button_sprite = button_object->addComponent<DisplayNode>()->initAs<DisplayNode::Sprite>();
